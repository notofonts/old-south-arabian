...
* 🔥 **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the "name" table: Expected "Noto Sans Old South Arabian" but got "Noto Sans OldSouArab". [code: mismatch]
...
* 🔥 **FAIL** OS/2.fsSelection bit 7 (USE_TYPO_METRICS) wasNOT set in the following fonts: ['fonts/NotoSansOldSouthArabian/googlefonts/ttf/NotoSansOldSouthArabian-Regular.ttf']. [code: missing-os2-fsselection-bit7]
...
* 🔥 **FAIL** On the 'name' table, the full font name 'Noto Sans Old South Arabian Regular' does not begin with the font family name 'Noto Sans OldSouArab' in platformID 3, encodingID 1, languageID 1033(0409), and nameID 1. [code: mismatch-font-names]
